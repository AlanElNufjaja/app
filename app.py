...
tamano_final = tamano_final # evitar tamaños negativos
...
energia = (0.5 * densidad * (4/3 * np.pi * radio_km**3) * velocidad_kms**2)/4.184e+10
...
st.write(f"**Energia del impacto:** {energia:.3f} MT")
