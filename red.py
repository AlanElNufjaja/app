def perdida_tamano_meteorito(densidad, velocidad_kms, tamano_inicial, factor_calor):
    ...
    perdida_tamano = (factor_calor * energia / densidad) / (1e7)  # Normalizar la pérdida de tamaño
    ...
    perdida_tamano = min(perdida_tamano, tamano_inicial * 0.9)  # No se desintegra completamente
